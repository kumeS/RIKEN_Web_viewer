...
// CopyURIのベースのパス  "........" をうめる
var BASE_URL = "http://clst.multimodal.riken.jp/CLST_Research_TestData/EM_Viewer_20170905_8W01_Sen_x5000_Rat_PC12WD6/index_mDZI.html";
// 1ピクセルあたりの マイクロメートル（デフォルト: 1px = 1/160 um = 0.00625 um = 6.25 nm）
// ここを更新すること
var PER_PIXEL_DEFAULT = 0.00472;
...
{ 
	...
	*/
	...
	var viewer = new OpenSeadragon({ // new OpenSeadragon's viewer
				...
				defaultZoomLevel: 0.08, // image's default zoom level
...
//var Pos01 = new OpenSeadragon.Point( Number(0.5),Number(0.5));
//alert(Pos01);
//viewer.viewport.zoomTo(Number(0.5), Pos01, true); 
//viewer.viewport.panTo(Pos01, false);

viewer.addTiledImage({
    tileSource: "DZI_images/DZI_IMAGE12b.dzi",
    x: 0.0035,
    y: 0.68975,
    width: 1
});
viewer.addTiledImage({
    tileSource: "DZI_images/DZI_IMAGE13b.dzi",
    x: 0.0035*2.5,
    y: 2 - (1-0.68975)*2 - 0.0023,
    width: 1
});
viewer.addTiledImage({
    tileSource: "DZI_images/DZI_IMAGE14b.dzi",
    x: 0.0035*3.92,
    y: 3 - (1-0.68975)*3 + 0.0005,
    width: 1
});
viewer.addTiledImage({
    tileSource: "DZI_images/DZI_IMAGE15b.dzi",
    x: 0.0035*5.4,
    y: 4  - (1-0.68975)*4 - 0.008,
    width: 1
});
viewer.addTiledImage({
    tileSource: "DZI_images/DZI_IMAGE16b.dzi",
    x: 0.0035*7.8,
    y: 5 - (1-0.68975)*5 - 0.0055,
    width: 1
});
/*
    viewer.addTiledImage({
