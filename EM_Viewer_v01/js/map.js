...
var TILE_SOURCE = './images/openseadragon/';

// デフォルトのオプション
var prefixUrlPath = "./js/vendor/openseadragon/images/";
// CopyURIのベースのパス
var BASE_URL = "http://penqe.com/emdb/";
// 1ピクセルあたりの マイクロメートル	
var PER_PIXEL_DEFAULT = 1.0/160.0;
// dzi のデフォルトの画像名
var DZI_IMAGEID = "emdb1";
...
//				alert(pinData.label);
	...
	MeasureBetweenAnnotation.prototype.drawAnnotations = function(sPinData,dPinData)
	{
		...
		distanceValue  = Number(distanceValue * realWidth).toFixed(6);
	...
	metaData.labelData = "Huge_fufa_piyo";
	metaData.derivesData = "Tissue";		
	metaData.taxData = "12345678";				
	metaData.strain_data = "Type A";
